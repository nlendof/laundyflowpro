    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          "washing-bg": "hsl(var(--status-washing-bg))",
          drying: "hsl(var(--status-drying))",
          "drying-bg": "hsl(var(--status-drying-bg))",
          ironing: "hsl(var(--status-ironing))",
          "ironing-bg": "hsl(var(--status-ironing-bg))",
